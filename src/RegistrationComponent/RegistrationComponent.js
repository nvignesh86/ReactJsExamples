...
export default function RegistrationComponent(props){
    ...
    return (
        ...
        <div>UserName: <input type="text" onChange={handleChange.bind(this,"userName")} value={userName} /></div>
        <div>Password: <input type="text" onChange={handleChange.bind(this,"password")} value={password} /></div>
        <div>Confirm Password: <input type="text" onChange={handleChange.bind(this,"confirmPassword")} value={confirmPassword} /></div>
